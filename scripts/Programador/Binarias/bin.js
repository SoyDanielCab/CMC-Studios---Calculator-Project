...
function resultado()
{
	...
	{	
		...
		solucion = parseInt(numespera,2) + operapendiente + parseInt(numpantalla,2);

		decimal = eval(solucion); //Linea que convierte el resultado en binario
		
		document.Calculadora.txtboxnros.value = decimal.toString(2); //Muestra el resultado en patalla
