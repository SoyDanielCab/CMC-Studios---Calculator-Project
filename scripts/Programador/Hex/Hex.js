...
function resultado()
{
	...
	{	
		...
		solucion = parseInt(numespera,16) + operapendiente + parseInt(numpantalla,16);

		decimal = eval(solucion); //Linea que convierte el resultado en binario
		
		document.Calculadora.txtboxnros.value = decimal.toString(16); //Muestra el resultado en patalla
